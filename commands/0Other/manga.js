...
النُجُوم⸙-˚ ָ ྀ🌸`,
        `مــآ أجــــٍمـــــلُ أن تــــبــــتــــســــم😊 حـــــــٍيَـــــن يَـــــظـــــًنّ آلُآخـ
      ];
      ...
      const apiUrl = `https://pin-two.vercel.app/pin?search=${encodeURIComponent(searchQuery.join(","))}`;
      ...
      await api.sendMessage({
        body: randomMessage,
        attachment: fs.createReadStream(imagePath), // تحويل الصورة إلى stream
      }, event.threadID);
